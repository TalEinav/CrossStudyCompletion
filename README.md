...
A random forest algorithm for matrix completion across multiple studies. This method is further refined in project [CAPYBARA](https://github.com/TalEinav/CAPYBARA).
